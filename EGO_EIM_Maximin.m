...
fprintf('EGO-EIM-Maximin on %d-D %s function, iteration: %d, evaluation: %d, hypervolume: %f \n',num_vari,fun_name,iteration,evaluation,hypervolume);
...
while evaluation < max_evaluation
    ...
    infill_x = Optimizer_GA(@(x)-Infill_EIM_Maximin(x,kriging_obj,non_dominated_front_scaled),num_vari,lower_bound,upper_bound,50,100);
